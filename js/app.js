...
function fitNameTitles() {
  fitTextToContainer($("#loader-title"), 60, 26);
  fitTextToContainer($("#guest-name"), 66, 28);
}
...
function updateCountdown() {
  ...
  if (now >= end) {
    finishCountdown("¡Gracias por compartir esta fiesta! 🎉");
    return;
  }
  ...
  if (days === 0) {
    ...
    countdownStatus.textContent = `Faltan ${days} días para festejar.`;
  }
}
